...
<body>
<header><div class="head-inner"><h1>新手 AI 外掛控制台 <span class="sub">Codex × Claude Code 入門系統</span></h1><div class="tabs"><button class="tab active" data-tab="guide">新手快速開始</button><button class="tab" data-tab="installGuide">安裝與外掛</button><button class="tab" data-tab="customSkill">個人化設定</button><button class="tab" data-tab="loopPrompt">Loop 提示詞</button><button class="tab" data-tab="automation">自動化設定</button><button class="tab" data-tab="daily">日常提示詞</button><button class="tab" data-tab="progress">專案開發（雙刀／單刀）</button><button class="tab" data-tab="prompts">提示詞庫</button><button class="tab" data-tab="skills">外掛 / Skill庫</button><button class="tab" data-tab="backup">備份 / 還原</button></div></div></header>
