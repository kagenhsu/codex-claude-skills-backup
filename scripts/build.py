...
<body>
<header><div class="head-inner"><h1>二刀流開發助手控制台 <span class="sub">Codex × Claude Code 開發系統</span></h1><div class="tabs"><button class="tab active" data-tab="guide">首頁 / 快速開始</button><button class="tab" data-tab="customSkill">自製 Skill</button><button class="tab" data-tab="daily">日常提示詞</button><button class="tab" data-tab="progress">開發進度</button><button class="tab" data-tab="prompts">提示詞庫</button><button class="tab" data-tab="skills">Skill庫</button><button class="tab" data-tab="capture">收錄新內容</button><button class="tab" data-tab="backup">換電腦／同步</button></div></div></header>
