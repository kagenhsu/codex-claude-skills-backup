...
<body>
<header><div class="head-inner"><h1>新手 AI 外掛控制台 <span class="sub">Codex Pro × Claude Code 入門系統</span></h1><div class="tabs"><button class="tab active" data-tab="guide">新手快速開始</button><button class="tab" data-tab="installGuide">安裝與外掛</button><button class="tab" data-tab="customSkill">個人化設定</button><button class="tab" data-tab="loopPrompts">Loop 提示詞</button><button class="tab" data-tab="automation">自動化設定</button><button class="tab" data-tab="daily">日常提示詞</button><button class="tab" data-tab="prompts">提示詞庫</button></div></div></header>
...
const PAGE_INTROS = {
  ...
  loopPrompts:{title:"Loop 提示詞",lead:"專門收錄會被反覆觸發、需要 AI 一輪一輪幫你跑的循環式提示詞。每張卡片都是純文字模板，複製後直接貼給 Codex 或 Claude Code 使用。",purpose:"把可以重複跑、可以串成迴圈的工作提示詞整理在一起。",first:"看 prompts.yaml 中 category 為「Loop 提示詞」的卡片；若分類空白，下方會顯示待補說明。",when:"想讓 AI 依固定節奏反覆執行同一類任務時，例如每日整理、每輪檢查、輪詢追蹤等。"}
};
...
function homeHtml(){return`<div class="wide-sop"><div class="home-hero"><h2>新手 AI 提示詞控制台</h2><p>這個公開頁面只做一件事：把可以複製的提示詞整理在不同分類底下，方便你挑、看、複製，再貼給 Codex 或 Claude Code 使用。頁面上不會幫你下載、安裝或執行任何本機腳本。</p><div class="summary" style="margin-top:10px">如果你是第一次接觸 AI 開發，建議先從 <b>Codex Pro</b> 開始慢慢摸熟，習慣怎麼和 AI 對話、下任務、看它的回覆，再依需要加上 Claude Code。</div><div class="summary" style="margin-top:10px">這套提示詞是我累積約五年 AI 使用經驗、一邊實作一邊整理出來的。目的不是一次學會全部，而是讓你先用得起來，再慢慢理解每張卡片在幫什麼。</div><div class="home-actions" style="margin-top:14px"><button class="copy-btn" type="button" data-home-tab="installGuide">先看安裝教學</button><button class="copy-btn" type="button" data-home-tab="prompts">我要複製提示詞</button><button class="copy-btn" type="button" data-home-tab="daily">我只想先試一段日常提示詞</button></div><div class="home-kpis"><div class="home-kpi"><b>新手先做什麼</b><div class="summary">先把 Codex 或 Claude Code 裝好，再回到這頁找你現在要用的提示詞。</div></div><div class="home-kpi"><b>這個頁面在幫什麼</b><div class="summary">把可重複使用的提示詞按分類整理好，讓你不用每次自己重寫。</div></div><div class="home-kpi"><b>使用原則</b><div class="summary">先用會用到的，不用第一天就把全部分類都研究完。</div></div></div></div><div class="home-panel" style="margin:16px 0"><h3>新手最簡單的使用順序</h3><div class="summary">第 1 步看「安裝與外掛」把官方 Codex / Claude Code 準備好 → 第 2 步到「日常提示詞」或「提示詞庫」找現在要用的內容 → 第 3 步把卡片複製貼給 AI，就能開始工作。</div><div class="summary" style="margin-top:8px">想要循環式、要 AI 反覆跑同一類任務時，可以跳到「Loop 提示詞」分類。</div></div><div class="home-steps"><div class="home-step"><span class="num">1</span><h3>先把工具準備好</h3><div class="summary">到「安裝與外掛」看官方 Codex / Claude Code 怎麼下載、登入。這頁本身不會替你安裝任何東西。</div></div><div class="home-step"><span class="num">2</span><h3>再找現在要用的提示詞</h3><div class="summary">想直接交辦事情，就去「提示詞庫」；想先試一段最簡單的問法，就到「日常提示詞」。</div></div><div class="home-step"><span class="num">3</span><h3>最後複製、貼給 AI</h3><div class="summary">每張卡片都附複製按鈕，按下後直接貼到 Codex 或 Claude Code 對話框即可。</div></div></div><div class="home-stack"><div class="home-panel"><h3>這個頁面在幫什麼</h3><div class="mini-list"><div class="mini-item"><b>找提示詞更快</b><div class="summary">分類清楚、可搜尋，不用每次都重寫一遍提示詞。</div></div><div class="mini-item"><b>提示詞直接複製</b><div class="summary">不知道怎麼下指令時，直接複製整理好的版本交給 AI 即可。</div></div><div class="mini-item"><b>純瀏覽、純複製</b><div class="summary">這頁不會在你的電腦上跑任何安裝、還原或啟動腳本。</div></div></div></div><div class="home-panel"><h3>每個分類在做什麼</h3><div class="mini-list"><div class="mini-item"><b>安裝與外掛</b><div class="summary">教你怎麼下載官方 Codex / Claude Code，適合第一次接觸的人。</div></div><div class="mini-item"><b>個人化設定</b><div class="summary">用選單組出個人化「給 AI 的提示詞模板」，整段複製給 AI 使用。</div></div><div class="mini-item"><b>Loop 提示詞</b><div class="summary">收錄會被反覆觸發、需要 AI 一輪一輪幫你跑的循環式提示詞。</div></div><div class="mini-item"><b>自動化設定</b><div class="summary">用表單組出「請 AI 幫我把這個流程做成自動化」的提示詞。</div></div><div class="mini-item"><b>日常提示詞</b><div class="summary">整理最常用的 AI 問法，讓你不知道怎麼開口時可以直接複製。</div></div><div class="mini-item"><b>提示詞庫</b><div class="summary">把較完整的工作提示詞整理在一起，適合正式交辦任務時用。</div></div></div></div></div></div>`}
...
function loopPromptsHtml(){const items=DATA.prompts.filter(p=>(p.category||"").trim()==="Loop 提示詞");const heroLead=`Loop 提示詞收錄會被反覆觸發、需要 AI 一輪一輪幫你跑的循環式提示詞。所有內容都是純文字模板，按下複製後直接貼給 Codex 或 Claude Code 使用。`;const hero=`<div class="card"><h2>Loop 提示詞</h2><div class="summary">${esc(heroLead)}</div><div class="summary" style="margin-top:8px">資料來源：<code>data/prompts.yaml</code> 中 <code>category: Loop 提示詞</code> 的卡片。要新增循環式提示詞，直接在 YAML 加項目並重新跑 <code>python3 scripts/build.py</code> 就會出現在這頁。</div></div>`;if(!items.length){return`<div class="sop wide-sop">${hero}<div class="card"><h2>目前還沒有 Loop 提示詞</h2><div class="summary">這個分類底下還沒有卡片。等 <code>data/prompts.yaml</code> 加入 <code>category: Loop 提示詞</code> 的項目後，這頁就會自動列出可複製的提示詞。</div></div></div>`}const cards=items.map(it=>`<div class="card prompt-card"><div class="meta"><b>${esc(it.title||"未命名")}</b>${it.usage?`<span class="summary">${esc(it.usage)}</span>`:""}</div><pre class="prompt-body">${esc(it.prompt||"")}</pre><div class="home-panel-actions"><button class="copy-btn" type="button" data-copy="${encodeURIComponent(it.prompt||"")}">複製提示詞</button></div></div>`).join("");return`<div class="sop wide-sop">${hero}<div class="grid">${cards}</div></div>`}
