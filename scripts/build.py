...
function bindHome(){
    ...
    hero.insertAdjacentHTML("afterend",`<div class="home-split skill-start-panel" style="margin-bottom:16px">
      ...
      <div class="home-panel">
        ...
        <div class="mini-list">
          ...
          <div class="mini-item"><b>3. 接續專案</b><div class="summary">有實際專案時，再進「開發進度」或「二刀流中控」。</div></div>
        </div>
  ...
  if(steps){
    steps.innerHTML=`<div class="home-step"><span class="num">1</span><h3>先做自製 Skill</h3><div class="summary">讓 AI 先理解你的職務、痛點、回答偏好與工作流程。這是個人化設定，不是直接安裝危險工具。</div></div><div class="home-step"><span class="num">2</span><h3>再找相關資訊</h3><div class="summary">依任務去「日常提示詞」、「提示詞庫」或「Skill庫」找可用內容，複製後交給 AI。</div></div><div class="home-step"><span class="num">3</span><h3>最後接續專案</h3><div class="summary">進入實際開發時，再看「開發進度」與「二刀流中控」，讓 Codex 和 Claude Code 分工完成。</div></div>`;
  }
