...
function renderOnlineBanner(){const el=document.getElementById("onlineBanner");if(!el)return;const isOnline=/\.github\.io$/i.test(location.hostname);if(!isOnline){el.innerHTML="";return}el.innerHTML=`<div class="online-banner"><div class="grow"><b>這是公開展示版，已改成新手也能上手的 AI 外掛系統</b><div class="summary">這裡可以直接看介面、複製提示詞、理解安裝流程與外掛怎麼搭配使用。頁面裡的範例進度、AGENTS、PRD 主要是示意用途，幫助第一次接觸的人先看懂整套工作方式。</div><div class="summary" style="margin-top:6px">如果你要長期使用，建議把完整版系統安裝到自己的電腦。安裝完成後，控制台主資料夾預設會在 <code>~/Documents/CodexClaudeSkillsConsole</code>（macOS）或 <code>我的文件\\CodexClaudeSkillsConsole</code>（Windows），之後你可以直接改裡面的 <code>data/prompts.yaml</code>、<code>data/skills.yaml</code> 來客製自己的流程。</div></div><button type="button" data-tab-jump="installGuide">安裝完整版系統</button></div>`;el.querySelector("[data-tab-jump]")?.addEventListener("click",()=>setTab("installGuide"))}
